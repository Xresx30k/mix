...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Welcome To XRESSX VPN SCRIPT ${YELLOW}(${NC}${green} Stable Edition ${NC}${YELLOW})${NC}"
echo -e " This Will Quick Setup VPN Server On Your Server"
echo -e "  Auther : ${green}XRESSX DIGITAL VPN® ${NC}${YELLOW}(${NC} ${green} XRESSX DIGITAL VPN ${NC}${YELLOW})${NC}"
echo -e " Recode By XRESSX DIGITAL VPN${YELLOW}(${NC} 2023 ${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
clear
url_izin="https://raw.githubusercontent.com/Xresx30k/mix/main/izin-ip-sandz"
...
REPO2="https://raw.githubusercontent.com/Xresx30k/mix/main/"
start=$(date +%s)
secs_to_human() {
